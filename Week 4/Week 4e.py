...
file_menu.add_command(label="Open...", underline=0,
                      command=lambda: msg.showerror(title="Error", message="Unable to open new file."))
...
help_menu.add_checkbutton(label="Send anonymous stats", onvalue=True, offvalue=False, variable=check_state,
                          command=print_state)
